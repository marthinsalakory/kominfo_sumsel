...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $q = mysqli_query($con, "UPDATE transaksi set No_Faktur='$_POST[No_Faktur]',No_Kamar='$_POST[No_Kamar]',No_Id='$_POST[No_Id]',tgl_masuk='$_POST[tgl_masuk]',tgl_keluar='$_POST[tgl_keluar]',lama_menginap='$_POST[lama_menginap]',Tarif='$_POST[Tarif]' where No_Faktur='$_POST[No_Faktur]'");
