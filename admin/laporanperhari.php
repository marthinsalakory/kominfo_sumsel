...
<td>-Pilih Tanggal-</td><td><input type="week" name="minggu_ini" value="<?php echo $minggu_ini; ?>"></td>
...
include "koneksi.php";
 if (isset($_POST['cari'])){
  $minggu_ini=$_POST['minggu_ini'];
  $sql= mysqli_query($con, "select * from reservasi where reservasi.tanggal_pesan='$minggu_ini'");
  }else{
